...
public class TestSinglyLinkedList {
    ...
    private static DoubleLinkList getLinkedList2() {
        DoubleLinkList list = new DoubleLinkList();
        list.addLast(1);
        list.addLast(2);
        list.addLast(3);
    ...
    public void test2() {
        DoubleLinkList list = getLinkedList2();
    ...
    private L01SinglyLinkedList getLinkedList3() {
        L01SinglyLinkedList list = new L01SinglyLinkedList();
        list.addLast(1);
        list.addLast(2);
        list.addLast(3);
        list.addLast(4);
    ...
    @DisplayName("测试递归遍历")
    public void Mytest() {
        L01SinglyLinkedList list = getLinkedList3();
        list.loop3(Value->{
            System.out.println("before:" + Value);
        },Value->{
            System.out.println("after:" + Value);
